    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-0 right-0 flex max-w-5xl flex-col items-start gap-y-6 bg-white px-8 py-12">
                <TitleLabel label="Why Choose Us" />
                <h2 className="section-title text-app-purple">
                    Transforming Technology <br /> Education for the Future
                </h2>
                <p className="text-lg">
                    We offer programs that combine practical learning,
                    mentorship, and <br /> global exposure to prepare young
                    innovators for the modern tech world.
                </p>
                <ul>
                    ...
                    <li className="flex items-center gap-2">
                        <CircleCheck className="size-6 text-white fill-app-orange" />
                        <span className="text-sm">
                            Innovative, youth-friendly programs and brand
                            experience
                        </span>
                    </li>
                </ul>
                ...
                <Link
                    href="/programs"
                    className="bg-app-purple hover:bg-app-purple/80 text-white rounded-none px-6 py-4 mt-4"
                >
                    Explore More
                </Link>
            </div>
