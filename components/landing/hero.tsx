...
const Hero = () => {
  return (
      <section id="hero" className="relative min-h-screen pt-24 sm:pt-28">
          <div className="absolute inset-0 -z-10 bg-[url('/images/rca-02.jpg')] bg-cover bg-center bg-no-repeat" />
          <div className="absolute inset-0 -z-10 bg-black/70" />

          <div className="px-4 py-16 sm:px-6 lg:px-6 flex flex-col items-center gap-2 mx-auto max-w-5xl">
              <TitleLabel label="Get-into-tech: Summer Camp 2026 | Coming soon" color="white"/>
              <div className="mt-6">
                  <h1 className="font-space-grotesk text-white text-6xl text-center">
                      Empowering{" "}
                      <span className="text-app-orange">
                          Young Tech <br /> Builders
                      </span>{" "}
                      to Build the Future
                  </h1>
                  <p className="text-white font-inter text-xl mt-4 text-center">
                      WithinTech Rwanda s a leading EdTech organization that
                      equips students with <br /> hands-on skills in coding,
                      robotics, and AI through mentorship, camps, and <br />{" "}
                      competitions.
                  </p>
              </div>
