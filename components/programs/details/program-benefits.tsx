...
const TestimonialCarousel = ({ testimonials }: { testimonials: Program["testimonials"] }) => {
    ...
    return (
        <section className="py-16 md:py-24">
            <div className="container px-4 md:px-8 grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 className="text-4xl md:text-5xl font-bold text-blue-900 mb-6">PROGRAM BENEFITS</h2>
                    <p className="text-lg md:text-xl text-gray-700 leading-relaxed">{program.benefitsText}</p>
                </div>
