    ...
    return (
        <section className="py-16 md:py-24 bg-blue-950 text-white">
            <div className="container px-4 md:px-8 grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <span className="inline-block bg-app-orange text-white px-5 py-2 rounded-none text-sm font-semibold mb-6">
                        {program.badge ?? program?.title}
                    </span>

                    <h2 className="section-title mb-6 capitalize">
                        {program.programIntroTitle.toLowerCase()}
                    </h2>
                    <p className="text-lg md:text-xl leading-relaxed opacity-90">
                        {program.programIntroText}
                    </p>
                </div>
