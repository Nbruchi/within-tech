...
export const programs: Program[] = [
    {
        ...
        whoForText: "Open to curious students who want an intensive tech immersion during the holidays. Perfect for those eager to build projects and discover new passions in STEM.",
        ages: "10 – 17",
        ...
        learnCards: [
            { title: "CODING & APP DEVELOPMENT", desc: "Build interactive games and apps using Scratch, Python, and block-based tools.", bgColor: "bg-sky-50" },
            { title: "ROBOTICS & ENGINEERING", desc: "Assemble and program robots to complete missions and solve problems.", bgColor: "bg-amber-50" },
            { title: "DESIGN & INNOVATION", desc: "Use design thinking to ideate, prototype, and present creative solutions.", bgColor: "bg-pink-50" },
        ],

        sampleIntro: "Each camp features rotating challenges to keep things fresh and fun.",
        sampleList: ["Create a climate action game", "Build a line-following robot", "Design a smart home prototype", "Team pitch at final showcase"],
        ...
        schedule: "Full days (9 AM – 4 PM) during school breaks (2–4 weeks depending on camp)",
        showcase: "Final day exhibition where campers present projects to parents and community",
        support: "All materials, laptops, and snacks provided; transport support available for some participants",
        howImages: ["/images/withintech-koica-01.jpg", "/images/withintech-koica-02.jpg"],
    },
    {
        id: "2",
        ...
        whoForText: "School-based clubs for students interested in regular tech exploration without long-term commitment.",
        ages: "8 – 18",
        levels: "Beginner – Intermediate",
        ...
        learnCards: [
            { title: "PROGRAMMING BASICS", desc: "Start with Scratch and move toward Python fundamentals.", bgColor: "bg-sky-50" },
            { title: "ROBOTICS PROJECTS", desc: "Build and code robots for challenges like maze navigation.", bgColor: "bg-amber-50" },
            { title: "TEAM PROBLEM-SOLVING", desc: "Collaborate on group projects and present solutions.", bgColor: "bg-pink-50" },
        ],

        sampleIntro: "Clubs rotate themes each term for variety.",
        sampleList: ["Maze-solving robot challenge", "Interactive story game in Scratch", "Simple sensor-based invention"],
        sampleImage: "/images/landing-pic-03.jpeg",

        programIntroTitle: "BRINGING TECH TO YOUR SCHOOL EVERY WEEK",
        programIntroText: "Clubs make STEM accessible right in school — regular fun sessions that spark ongoing curiosity.",
        programIntroImage: "/images/landing-pic-03.jpeg",

        howItWorksText: "School-hosted weekly clubs with trained facilitators and provided kits.",
    ...
    },
    {
        ...
        badge: "Girls in Stem",
        whoForText: "We welcome girls aged 8–17 - from complete beginners to the already curious. Learners join from our Kigali makerspace and partner schools across Nairobi and beyond. Everyone gets a chance to participate; sponsored seats help ensure cost is never a barrier.",
        ages: "8 – 17",
        levels: "Beginner – Intermediate",
        ...
        learnCards: [
            { title: "CODING FUNDAMENTALS", desc: "Master the basics of programming with beginner-friendly tools like Scratch and Python, building a strong foundation for future tech exploration.", bgColor: "bg-sky-50" },
            { title: "ROBOTICS & ELECTRONICS", desc: "Explore the exciting world of robotics, learning to build and program simple electronic circuits and devices through hands-on projects.", bgColor: "bg-amber-50" },
            { title: "DESIGN THINKING", desc: "Develop critical thinking skills by applying design thinking principles to identify problems and create innovative solutions for real-world challenges.", bgColor: "bg-pink-50" },
        ],

        sampleIntro: "Activities rotate each term to keep learning fresh and exciting. Recent challenges included building an animated story app, creating a smart plant-watering system using sensors, and presenting a robotics build at our mini showcase.",
        sampleList: [
        ...
        howImages: ["/images/landing-pic-01.jpeg", "/images/landing-pic-04.jpg"],
    },
    {
        id: "4",
        ...
        whoForText: "Ideal for space enthusiasts and students curious about satellites, astronomy, and aerospace engineering.",
        ages: "10 – 18",
        levels: "Beginner – Intermediate",
        ...
        learnCards: [
            { title: "SPACE SCIENCE BASICS", desc: "Learn about planets, orbits, and satellites with hands-on models.", bgColor: "bg-sky-50" },
            { title: "ROBOTICS FOR SPACE", desc: "Build rovers and probes that simulate space missions.", bgColor: "bg-amber-50" },
            { title: "SATELLITE & DATA", desc: "Code simple data loggers and understand remote sensing.", bgColor: "bg-pink-50" },
        ],

        sampleIntro: "Projects inspired by real space missions.",
        sampleList: ["Build a Mars rover prototype", "Code a satellite tracker simulation", "Rocket launch challenge"],
        sampleImage: "/images/space-tech-01.jpg",

        programIntroTitle: "LAUNCHING YOUNG MINDS INTO SPACE EXPLORATION",
        programIntroText: "GIST ignites passion for space while teaching engineering, coding, and scientific inquiry through exciting projects.",
        programIntroImage: "/images/space-tech-01.jpg",

        howItWorksText: "Monthly intensive sessions with guest astronomers and engineers.",
    ...
    },
    {
        ...
        whoForText: "Creative coders ready to tackle AI challenges and present solutions in a fun competition format.",
        ages: "12 – 18",
        levels: "Intermediate",
        ...
        learnCards: [
            { title: "AI BASICS & ETHICS", desc: "Understand machine learning, bias, and responsible AI.", bgColor: "bg-sky-50" },
            { title: "BUILDING AI PROJECTS", desc: "Create image recognizers, chatbots, or predictors with tools like Teachable Machine.", bgColor: "bg-amber-50" },
            { title: "PRESENTATION & JUDGING", desc: "Pitch your solution and receive feedback from experts.", bgColor: "bg-pink-50" },
        ],

        sampleIntro: "Past competition themes and winning ideas.",
        sampleList: ["AI plant disease detector", "Voice-controlled assistant", "Emotion recognition game"],
        sampleImage: "/images/rca-02.jpg",

        programIntroTitle: "COMPETING WITH CREATIVITY IN AI",
        programIntroText: "A thrilling challenge where young minds build, test, and showcase AI solutions — learning while having fun.",
        programIntroImage: "/images/rca-02.jpg",

        howItWorksText: "Mentored project development leading to a showcase competition.",
    ...
    },
    {
        ...
        whoForText: "University students passionate about tech education and mentoring — gain leadership and technical experience.",
        ...
        learnCards: [
            { title: "MENTORSHIP SKILLS", desc: "Guide younger learners through projects and challenges.", bgColor: "bg-sky-50" },
            { title: "ADVANCED PROJECTS", desc: "Work on real tools like AI, web dev, or robotics kits.", bgColor: "bg-amber-50" },
            { title: "COMMUNITY IMPACT", desc: "Design sessions and contribute to program growth.", bgColor: "bg-pink-50" },
        ],

        sampleIntro: "Intern tasks and responsibilities.",
        sampleList: ["Facilitate weekly coding sessions", "Develop new workshop materials", "Assist in competition prep"],
        ...
        support: "Training, stipend (where possible), certificates, recommendation letters",
